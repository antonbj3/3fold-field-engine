...
def main():
    libraries = dict(fused_library=os.environ['MESH_FUSED_QUOTIENT_LIBRARY'],
                     winding_library=os.environ['RT_COLUMNS_LIBRARY'], ptx=os.environ['RT_INTERVAL_PTX'],
    ...
    sources = ('mesh_field_shared_service_v1.py', 'mesh_fused_into_v1.py', 'mesh_fused_shared_v1/field.cu', 'mesh_fused_tail_graph_v1/field.cu', 'mesh_field_owned_service_v1.py',
               'rt_columns_interval_v1/filter.cuh', 'rt_columns_interval_v1/program.cu', 'edt_pair_quotient_v1/quotient.cuh', 'edt_pair_quotient_v1/edt.cu', 'mesh_fused_quotient_v1/field.cu', 'mesh_fused_quotient_shared_v1/field.cu', 'mesh_fused_quotient_graph_v1/field.cu', 'mesh_fused_native_v1/field.cu', 'field_quotient_service_probe.py')
    ...
    (ROOT/'reports/field_quotient_service.json').write_text(json.dumps(report, indent=2) + '\n')
    np.savez_compressed(ROOT/'reports/field_quotient_service_arrays.npz', **captures)
