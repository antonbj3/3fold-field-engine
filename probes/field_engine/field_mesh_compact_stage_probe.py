...
from mesh_field_compact_v1 import PreparedMeshField
...
def main():
    ...
    (folder/'mesh_compact_stage.json').write_text(json.dumps(report,indent=2)+'\n');np.savez_compressed(folder/'mesh_compact_stage_arrays.npz',**arrays)
