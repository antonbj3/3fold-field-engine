...
def main():
    ...
    sources = ('mesh_field_shared_service_v1.py', 'mesh_fused_into_v1.py', 'mesh_fused_shared_v1/field.cu', 'mesh_fused_tail_graph_v1/field.cu', 'mesh_field_owned_service_v1.py',
               'mesh_fused_native_v1/field.cu', 'field_owned_gpu_probe.py')
    ...
    (ROOT/'reports/field_owned_gpu.json').write_text(json.dumps(report, indent=2) + '\n')
    np.savez_compressed(ROOT/'reports/field_owned_gpu_arrays.npz', **captures)
