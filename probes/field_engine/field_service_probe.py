"""Fresh worker and warm full-field IPC timing, with an unchanged 2 ms L gate."""
...
from mesh_field_service_v1 import MeshFieldService
...
def main():
    ...
    libraries = dict(winding_library=os.environ['RT_COLUMNS_LIBRARY'], ptx=os.environ['RT_COLUMNS_PTX'],
    ...
    (ROOT/'reports/field_service.json').write_text(json.dumps(report, indent=2)+'\n')
    np.savez_compressed(ROOT/'reports/field_service_arrays.npz', **captures)
