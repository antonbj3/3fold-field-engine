"""Measure frozen single-shot RT lifecycle before a reusable-context design."""
...
def main():
    ...
    out=ROOT/'artifacts'
    (out/'field_rt_lifecycle_v1.json').write_text(json.dumps(report,indent=2)+'\n')
    np.savez_compressed(out/'field_rt_lifecycle_v1_arrays.npz',**outputs)
