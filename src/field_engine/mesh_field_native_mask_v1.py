...
class PreparedMeshField:
    def __init__(self,vertices,faces,pitch,lo,*,winding_library,ptx,edt_library,column_library,global_shape=None,margin_vox_pad=2):
...
def surface_raster_and_flood_rt(vertices,faces,pitch,lo,*,winding_library,ptx,edt_library,column_library,global_shape=None,margin_vox_pad=2):
    """One-shot stage including preparation/close; no hidden global cache."""
    with PreparedMeshField(vertices,faces,pitch,lo,winding_library=winding_library,ptx=ptx,edt_library=edt_library,column_library=column_library,
...
if __name__=='__main__':
    ...
    from field_mesh_native_mask_stage_probe import main
